from pybricks.tools import tasks
...
async def test_all_1():
    ...
    print(await tasks.all(task1, task2))
...
async def test_race_1():
    ...
    print(await tasks.race(task1, task2))
